...
*/
const auth0ClientId = 'YSecAbQYWIe51VyQV9yZwOsm0yHe7UD0';
const auth0Domain = 'https://dev-35k9xvev.auth0.com';
...
export default class App extends React.Component {
  ...
  handleResponse = (response) => {
    ...
    console.log("Here's what's in Decoded: ");
    console.log(decoded);
    const { name, picture, aud } = decoded;
    this.props.saveUser(decoded);
